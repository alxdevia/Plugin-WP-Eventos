<?php
    ...
    /**
     * AJAX: Detección de etiquetas (Ads, Analytics, Facebook, LinkedIn, etc.) 
     * en la home.
     *
     * Modificación: este endpoint solo se ejecuta para usuarios autenticados con rol administrador.
     */
